...
type ThumbnailServiceClient interface {
	GetThumbnail(ctx context.Context, in *GetThumbnailRequest, opts ...grpc.CallOption) (*Thumbnail, error)
}
...
func (c *thumbnailServiceClient) GetThumbnail(ctx context.Context, in *GetThumbnailRequest, opts ...grpc.CallOption) (*Thumbnail, error) {
	out := new(Thumbnail)
	err := c.cc.Invoke(ctx, "/thumb.proto.ThumbnailService/GetThumbnail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ThumbnailServiceServer interface {
	GetThumbnail(context.Context, *GetThumbnailRequest) (*Thumbnail, error)
...
func (UnimplementedThumbnailServiceServer) GetThumbnail(context.Context, *GetThumbnailRequest) (*Thumbnail, error) {
...
func _ThumbnailService_GetThumbnail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/thumb.proto.ThumbnailService/GetThumbnail",
	}
...
var ThumbnailService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "thumb.proto.ThumbnailService",
